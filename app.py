...
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'nz.cl888.dpdns.org:8008')                  # 哪吒3个变量不全不运行
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'unxsk3wLWNgGptGvRrL7V8q8bm3M6XjV')                             # 国定隧道域名，留空即启用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'cho.cl999.eu.org')                                 # 国定隧道json或token，留空即启用临时隧道,json获取地址：https://fscarmen.cloudflare.now.cc
