...
UUID = os.environ.get('UUID', '9afd1229-b893-40c1-84dd-51e7ce204913')       # UUID
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'agent.cl888.dpdns.org:80')                  # 哪吒3个变量不全不运行
NEZHA_PORT = os.environ.get('NEZHA_PORT', '')                           # 哪吒端口为{443,8443,2096,2097,2083}其中之一时自动开启tls
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'unxsk3wLWNgGptGvRrL7V8q8bm3M6XjV')                                 # 哪吒客户端密钥
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', '318app.cl999.eu.org')                             # 国定隧道域名，留空即启用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiNTg0OTAyYjAzNjAzMzM0NDZiNWY4OGNiZGMxYWViMmIiLCJ0IjoiNjA4MjMwZDUtNjU3OS00MDViLWFhMDEtMTEwZmU4ZTlkNTE5IiwicyI6Ik1UZzBNems1Wm1VdFpEWTNPQzAwWmpjekxUaGpPR010WlRCak16RmxORFV3TkdNMCJ9')                                 # 国定隧道json或token，留空即启用临时隧道,json获取地址：https://fscarmen.cloudflare.now.cc
ARGO_PORT = int(os.environ.get('ARGO_PORT', 8001))                          # Argo端口，固定隧道token请改回8080或在cf后台设置的端口与这里对应
CFIP = os.environ.get('CFIP', 'ct.090227.xyz')                            # 优选域名或优选ip
